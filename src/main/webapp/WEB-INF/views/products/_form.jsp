...
<label for="${AttributeConst.PRD_NAME.getValue()}">商品名</label><br />
<input type="text" name="${AttributeConst.PRD_NAME.getValue()}" id="${AttributeConst.PRD_NAME.getValue()}" value="${product.name}" size="35"/>
<br /><br />
...
<label for="${AttributeConst.PRD_MTRL.getValue()}">素材</label><br />
<input type="text" name="${AttributeConst.PRD_MTRL.getValue()}" id="${AttributeConst.PRD_MTRL.getValue()}" value="${product.material}" />
<br /><br />

<label for="${AttributeConst.PRD_CONTENT.getValue()}">商品説明</label><br />
<textarea name="${AttributeConst.PRD_CONTENT.getValue()}" id="${AttributeConst.PRD_CONTENT.getValue()}" rows="10" cols="60">${product.content}</textarea>
<br /><br />

<label for="${AttributeConst.PRD_QUANTITY.getValue()}">在庫数</label><br />
<input type="number" name="${AttributeConst.PRD_QUANTITY.getValue()}" id="${AttributeConst.PRD_QUANTITY.getValue()}" value="${product.quantity}"size="4">
<br /><br />
