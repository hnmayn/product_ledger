    ...
    <c:param name="content">
        ...
        <table>
            <tbody>
                ...
                <th>活動状況</th>
                <td><c:choose>
                        <c:when test="${product.obsoleteFlag == AttributeConst.PRD_OBS_TRUE.getIntegerValue()}">廃盤</c:when>
                        <c:otherwise>通常販売</c:otherwise>
                    </c:choose></td>
                </tr>
                <tr>
                    <th>登録日時</th>
                    <fmt:parseDate value="${product.createdAt}" pattern="yyyy-MM-dd'T'HH:mm:ss" var="createDay" type="date" />
                    <td><fmt:formatDate value='${createDay}' pattern="yyyy-MM-dd HH:mm:ss" /></td>
                </tr>
                <tr>
                    <th>更新日時</th>
                    <fmt:parseDate value="${product.updatedAt}" pattern="yyyy-MM-dd'T'HH:mm:ss" var="updateDay" type="date" />
